                ...
                <div className={style.block1}>
                    ...
                    <div>
                        ...
                        <p className={style.text}>
                            В нашем каталоге собраны животные, которые готовы<br/>
                            покинуть приюты,чтобы обрести настоящую,любящую<br/>
                            семью. Взрослые коты и собаки,забавные котята и щенки-<br/>
                            на нашей онлайн-платформе вы найдете своего<br/>
                            друга,который вас никогда не придаст и будет Вам<br/>
                            бесконечно благодарен и предан.
